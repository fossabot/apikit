...
public class ApplicationModelWrapper {
  ...
  private ApikitConfig createApikitConfig(ComponentModel unwrappedApikitConfig) {
    ...
    return new ApikitConfig(configName, configRaml, flowMappings, httpStatusVarName, outputHeadersVarName, Optional.empty(),
                            notifier);
  }
  ...
  public Optional<ApiCoordinate> getApiCoordinatesForFlow(String flowName) {
