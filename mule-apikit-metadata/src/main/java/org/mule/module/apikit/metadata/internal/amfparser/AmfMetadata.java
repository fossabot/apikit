...
public class AmfMetadata extends AbstractMetadata {

  public AmfMetadata(final ApplicationModel model, final ResourceLoader loader, final Notifier notifier) {
  ...
  protected MetadataResolverFactory createMetadataResolverFactory(final ResourceLoader loader, final Notifier notifier) {
    return new AmfHandler(loader, notifier);
  }
}
