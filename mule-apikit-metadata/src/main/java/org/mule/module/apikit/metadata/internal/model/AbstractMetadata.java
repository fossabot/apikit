...
public abstract class AbstractMetadata implements Metadata {
  ...
  protected AbstractMetadata(final ApplicationModel model, final ResourceLoader loader, final Notifier notifier) {
    this.applicationModel = new ApplicationModelWrapper(model, createMetadataResolverFactory(loader, notifier), notifier);
